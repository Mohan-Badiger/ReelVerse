...
const AddMovieModal = ({ isOpen, onClose, onAdd }) => {
    ...
    const validateStep = (currentStep) => {
        if (currentStep === 1) {
            return formData.title && formData.description && formData.genre && formData.language;
        }
        if (currentStep === 2) {
            return formData.duration && formData.releaseDate;
        }
        return true;
    };
                ...
                <>
                    ...
                    >
                        ...
                        <div className="w-64 bg-[#111] border-r border-base-800/50 p-8 hidden md:flex flex-col">
                            <div className="mb-10">
                                <h2 className="text-xl font-bold text-white mb-1">New Movie</h2>
                                <p className="text-xs text-base-500 font-medium uppercase tracking-widest">ReelVerse Catalog</p>
                            </div>
                                ...
                                {steps.map((s) => (
                                    <div key={s.id} className="relative z-10 flex items-center gap-4 group">
                                        ...
                                        <div className="flex flex-col">
                                            ...
                                            {step === s.id && (
                                                <motion.span layoutId="stepIndicator" className="text-[10px] text-primary-400 font-medium">In Progress</motion.span>
                                            )}
                                        </div>
                                    </div>
                                ))}
                            ...
                            <div className="mt-auto">
                                <div className="bg-base-900/50 border border-base-800/50 rounded-lg p-4">
                                    <div className="flex items-start gap-3">
                                        <Info size={16} className="text-primary-400 shrink-0 mt-0.5" />
                                        <p className="text-[11px] text-base-400 leading-relaxed">
                                            Fill in all required fields to publish this movie to the platform.
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="flex-1 flex flex-col bg-base-950/50 relative overflow-hidden">
                            ...
                            <button
                                onClick={handleClose}
                                className="absolute top-6 right-6 text-base-500 hover:text-white transition-colors z-20"
                            >
                                <X className="w-5 h-5" />
                            </button>
                                    ...
                                    {step === 1 && (
                                        ...
                                        >
                                            <div className="space-y-1">
                                                ...
                                                <p className="text-base-400">Tell us the basics about this cinematic piece.</p>
                                            </div>

                                            <div className="space-y-6">
                                                <div className="group">
                                                    <label className="block text-[10px] font-bold text-base-500 uppercase tracking-[0.2em] mb-2 group-focus-within:text-primary-400 transition-colors">Movie Title</label>
                                                    <input
                                                        type="text"
                                                        name="title"
                                                        value={formData.title}
                                                        onChange={handleChange}
                                                        className="w-full bg-transparent border-b border-base-800 py-3 text-lg text-white placeholder-base-700 focus:outline-none focus:border-primary-500 transition-colors"
                                                ...
                                                <div className="grid grid-cols-2 gap-8">
                                                    <div>
                                                        <label className="block text-[10px] font-bold text-base-500 uppercase tracking-[0.2em] mb-2">Primary Genre</label>
                                                        <select
                                                            name="genre"
                                                            value={formData.genre}
                                                            onChange={handleChange}
                                                            className="box-input bg-base-900/50 border-base-800 rounded-lg"
                                                        >
                                                    ...
                                                    <div>
                                                        <label className="block text-[10px] font-bold text-base-500 uppercase tracking-[0.2em] mb-2">Original Language</label>
                                                        <select
                                                            name="language"
                                                ...
                                                <div>
                                                    ...
                                                    <textarea
                                                        ...
                                                        onChange={handleChange}
                                                        rows="4"
                                                        className="box-input bg-base-900/50 border-base-800 rounded-lg resize-none"
                                        ...
                                        >
                                            ...
                                            <div className="grid grid-cols-2 gap-6">
                                                <div>
                                                    ...
                                                    <input type="number" name="duration" value={formData.duration} onChange={handleChange} className="box-input bg-base-900/50" placeholder="120" />
                                                </div>
                                                <div>
                                                ...
                                                <div>
                                                    ...
                                                    <input type="text" name="director" value={formData.director} onChange={handleChange} className="box-input bg-base-900/50" placeholder="Director name..." />
                                                </div>
                                                <div>
                                                    <label className="block text-[10px] font-bold text-base-500 uppercase tracking-[0.2em] mb-2">IMDb Rating</label>
                                                    <input type="number" step="0.1" name="rating" value={formData.rating} onChange={handleChange} className="box-input bg-base-900/50" placeholder="8.5" />
                                                </div>
                                            </div>

                                            <div>
                                                <label className="block text-[10px] font-bold text-base-500 uppercase tracking-[0.2em] mb-2">Lead Cast (Comma separated)</label>
                                                <input type="text" name="cast" value={formData.cast} onChange={handleChange} className="box-input bg-base-900/50" placeholder="Actor 1, Actor 2..." />
                                            </div>
                                        </motion.div>
                                    )}
                                    ...
                                    {step === 3 && (
                                        ...
                                        >
                                            <div className="space-y-1">
                                                ...
                                                <p className="text-base-400">Upload visual content for the movie profile.</p>
                                            </div>

                                            <div className="grid grid-cols-2 gap-8">
                                                <div>
                                                    <label className="block text-[10px] font-bold text-base-500 uppercase tracking-[0.2em] mb-3">Movie Poster</label>
                                                    <div className="relative aspect-2/3 w-full border-2 border-dashed border-base-800 hover:border-primary-500 rounded-xl bg-base-900/30 group transition-all overflow-hidden flex flex-col items-center justify-center cursor-pointer">
                                                        {previewUrl ? (
                                                            <>
                                                ...
                                                <div className="space-y-6">
                                                    <div>
                                                        ...
                                                        <input type="text" name="trailerUrl" value={formData.trailerUrl} onChange={handleChange} className="box-input bg-base-900/50" placeholder="https://youtube.com/watch?v=..." />
                                                    </div>
                            ...
                            <div className="p-8 border-t border-base-800/50 flex justify-between items-center bg-[#0d0d0d] relative z-10">
                                <p className="text-[10px] text-base-500 font-bold uppercase tracking-widest">
                                    Step {step} of 3
                                </p>
                                <div className="flex gap-4">
                                    {step > 1 && (
                                        <button
                                            onClick={prevStep}
                                            className="px-6 py-2.5 rounded-lg text-sm font-bold text-base-400 hover:text-white flex items-center gap-2 transition-colors"
                                        >
                                    ...
                                    {step < 3 ? (
                                        <button
                                            onClick={nextStep}
                                            className="box-button-primary px-8 flex items-center gap-2"
                                        >
                                        ...
                                        <button
                                            ...
                                            disabled={isLoading}
                                            className="box-button-primary px-8 bg-emerald-600 hover:bg-emerald-500 shadow-[0_0_20px_rgba(16,185,129,0.2)]"
                                        >
