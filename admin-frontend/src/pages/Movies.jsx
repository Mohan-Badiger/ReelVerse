                            ...
                            <tbody className="divide-y divide-base-800/60">
                                {movies.filter(m => m.title.toLowerCase().includes(searchTerm.toLowerCase())).map((movie, index) => (
                                    ...
                                    >
                                        ...
                                        <td className="py-4 px-6">
                                            {movie.isUpcoming ? (
                                                <span className="px-2.5 py-1 bg-amber-500/10 border border-amber-500/20 rounded text-xs text-amber-400 font-medium whitespace-nowrap">
                                                    Upcoming
                                                </span>
                                            ) : (
                                                <span className="px-2.5 py-1 bg-emerald-500/10 border border-emerald-500/20 rounded text-xs text-emerald-400 font-medium whitespace-nowrap">
                                                    Now Showing
                                                </span>
                                            )}
                                        </td>
