...
const AdminLogin = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Instead of putting admin info in standard user Redux state, 
            // the admin session is validated via HTTP-only securely.
            // We just navigate them into the protected zone.
